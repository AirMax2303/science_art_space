...
var experts = [
  ...
  Expert('1', 'Копонева О.В.', 'Директор Технопарка КубГУ',
      'assets/experts/koponeva.jpg'),
  Expert('1', 'Волкова Т.А.', 'Программный директор «Точка кипения КубГУ»',
  ...
  Expert('1', 'Говорова Г.Н.', 'Директор Департамента по международным связям',
  ...
  Expert('1', 'Шведчиков Н.Ю.', 'Генеральный директор ООО Экстраверт',
      'assets/experts/svedchikov.jpg'),
  Expert('1', 'Золотарёв С.С.', 'Генеральный директор ООО «М-АРТ»',
      'assets/experts/zolotarev.jpg'),
  Expert('1', 'Зыкова Е.В.', 'Управляющий партнёр «ARTEЛЬ DIGITAL»',
      'assets/experts/zikova.jpg'),
  Expert('1', 'Соколова', 'Настоящий знаток и ценитель',
      'assets/experts/sokolova.jpg'),
  Expert('1', 'Фоменко Михаил', 'Настоящий знаток и ценитель',
